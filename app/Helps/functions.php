...
/**
* 发送post请求
* @param string $req 可为一个url地址，或一个array[url,params]
* @param string[] $data
* @param array $header
* @param int $timeout
* @throws Exception
...
*/
function http_post($req, $data, $header = array(), $timeout = 30) 
{
    $url = makeUri($req);
...
* @throws Exception
*/
function http_get($req, $header = array(), $timeout = 30) 
{
    $url = makeUri($req);
    if (!function_exists('curl_init')) {
        throw new Exception('server not install curl');
